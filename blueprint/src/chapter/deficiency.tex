...
\end{lemma}
\begin{proof}
  By \cref{lem:matroid-restrict-subgraph}, $M(\tilde H) = M(\tilde
  G)|E(\tilde H)$, so the base / fiber-meeting minimality property
  descends from $G$ to $H$; Katoh--Tanigawa~\cite[Lemma
