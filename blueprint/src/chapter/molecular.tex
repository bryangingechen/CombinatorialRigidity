...
(\cref{sec:molecular-rigidity-matrix}) are likewise formalized
(\texttt{Molecular/RigidityMatrix.lean}) save for the single
reconciliation node \cref{prop:rigidity-matrix-prop11}, whose proof
routes through Phase~19 objects and is deferred there; see that
section's \emph{Status} block.
