...
\begin{proof}
  ...
  Since $\underline{D} = E(G)$
  (\cref{lem:runPebbleGameWith-underline-subset} applied at $D =
  \mathtt{empty}$, plus the converse $E(G) \subseteq \underline{D'}$
  from the no-skip-fires argument), this is exactly $|\edgesIn[G]{V'}|
