...
\begin{definition}[Path-reversal move]
  ...
  while increasing $\mathrm{out}_D(u_m)$ by $1$. The
  invariant-preservation half is formalised; the structural
  \texttt{out}/\texttt{peb}/\texttt{span}/\texttt{outOn} lemmas
  follow in subsequent commits feeding
