...
\begin{proof}
  ...
  \cref{lem:affine-indep-iff}, to supply it), so the affine-free core
  \texttt{omitTwoExtensor\_linearIndependent\_of\_li} holds for any
  linearly-independent family; the Case~III spanning consumer
  (\cref{lem:case-III-claim612-extensor-span}) is fed bare homogeneous
  vectors and uses that form directly.
\end{proof}
