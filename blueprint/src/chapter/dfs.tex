...
from $v$, as a $\mathrm{Finset}\,V$. Phase 11's Layer 1 ships this
view as a computable primitive
$\mathrm{reachClosureComputable}$, eliminating the
$\mathtt{Classical.decPred}$ dependency that an earlier
filter-based formulation would have introduced. Its semantic
