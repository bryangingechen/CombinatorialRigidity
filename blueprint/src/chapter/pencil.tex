...
\begin{theorem}[Pencil realization from the contraction and split cases, conditioned pair]
  ...
  two-edge-connected with no proper rigid subgraph. Then every
  multigraph on the whole ambient body set satisfies the conditioned
  pair at $n = 3$.
\end{theorem}
\begin{proof}
  ...
  simple; the base case's remaining sub-cases and the cut-edge case's
  generic conjunct remain to be established.
\end{proof}
