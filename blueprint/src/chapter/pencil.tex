...
\end{lemma}
\begin{proof}
  \uses{lem:pencil-projective-transport}
  ...
  rank); a generic choice of automorphism meets the two cross-incidences by
  \cref{lem:two-pencil-extension-iff}, a codimension-two condition against
