...
\begin{lemma}[The cut-edge case]
  ...
  \uses{def:pencil-rank-hypothesis, def:cut-edges-2ec,
        lem:two-pencil-extension-iff}
  Let $G$ be loopless with $|V(G)| \ge 3$, not two-edge-connected, with at
...
\begin{proof}
  ...
  two cross-incidences hold; a generic projective repositioning of one side
  meets them by \cref{lem:two-pencil-extension-iff}, a codimension-two
  condition against the projective automorphism group
  (\cref{thm:projective-invariance}).
\end{proof}
