...
\begin{fmlnote}
  ...
  and (K) is additionally implied by the rank-nullity structure
  Katoh--Tanigawa's own Claim 6.12~\cite{katohTanigawa2011} establishes for
  its three candidate certificates $M_1, M_2, M_3$ — one of which is always
  nonsingular at a generic seed.
\end{fmlnote}
\begin{proof}
  \leanok
