...
\begin{definition}[Nondegenerate pencil realization, feasibility]
  ...
  \lean{Graph.PencilHub, Graph.closedHubNbhd,
  ...
  itself and its neighbours. A pencil realization of $G$
  (\cref{def:pencil-panel-realization}) is \emph{nondegenerate} when the
  two concurrency points of every link are projectively distinct, and,
  at every vertex, the panel normals of its closed hub-neighbourhood are
