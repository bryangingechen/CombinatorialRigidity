...
pairing and its off-diagonal vanishing on the standard exterior-power basis
(the pairing of the basis vectors indexed by $S$ and $T$ is $0$ unless
$T = S^{c}$) are formalized; the diagonal sign ($\pm 1$ on $T = S^{c}$) and
the resulting nondegeneracy remain. The regressive product
(\cref{def:meet}) remains to be formalized.
