...
(\cref{def:meet-pairing-dual}), and the complement iso
(\cref{def:meet-complement-iso}) are green, formalized in
\texttt{Molecular/Meet.lean} (with the general facts mirrored under
\texttt{Mathlib/LinearAlgebra/ExteriorPower/Basis.lean}). The regressive
