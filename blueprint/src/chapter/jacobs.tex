...
\begin{fmlnote}
  ...
  (\cref{lem:normal-cross-count-partition}). What remains in
  \cref{lem:normal-cross-count} is the arithmetic of the disjoint-union
  count: summing the constant fiber size $2$ over the $d_G(A)$ fibers.
\end{fmlnote}
