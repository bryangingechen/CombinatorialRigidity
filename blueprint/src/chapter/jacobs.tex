...
\begin{proof}
  \uses{lem:square-cliques, lem:clique-edgesIn-count,
    ...
    lem:square-cross-classification}
...
\begin{proof}
  \uses{lem:square-cross-classification, lem:isLaman3-degree-le-three,
    lem:tight-partition-parts, lem:tight-partition-cross-pair-nbr}
  ...
  (\cref{lem:tight-partition-cross-pair-nbr}), and every normal cross edge
