...
nodes are green and which are red. All Phase~1--6 nodes are green;
the Phase~7 dep-graph (under \cref{sec:rigidity-matroid} and
\cref{sec:count-matroid}) still has red leaves --- those are the
in-progress targets.
