...
Phases~1--8 are complete: the first six phases formalize Laman's
...
and Phase~8 reframes it as a linear matroid via \texttt{Matroid.ofFun}
at a uniformly generic placement (Lov\'asz--Yemini, linear-matroid
form). Phase~9 (basic $(k, \ell)$-pebble game of
Lee--Streinu~\cite{leeStreinu2008}, in the matroidal regime
$\ell < 2k$) is in progress, preceded by a verified-DFS warmup.
...
fit together; nodes on the main Laman line, through the Phase~8
linear-matroid framing, and across the verified-DFS warmup
(\cref{sec:dfs}) are all green, with the Phase~9 pebble-game chapter
(\cref{sec:pebble-game}) still red.
