...
documentation. Statements without proofs are marked accordingly. The
dependency graph view (linked from the navigation bar) shows the
informal-to-formal connection at a glance.
