...
The first six phases are complete and Laman's theorem is fully
formalized; Phase~7 is in progress and extends the development with
the Lov\'asz--Yemini matroid identification.
...
\begin{enumerate}
  ...
  \item \textbf{Lov\'asz--Yemini matroid identification.} The harder
        ...
        placement, packaged with Phase~6 into a `Matroid` instance for
        the rigidity matroid in dimension~$2$.
        (File: \texttt{MatroidIdentification.lean}.)
\end{enumerate}
...
documentation. The \emph{dependency graph view} (linked from
the navigation bar) is the best place to see at a glance which
nodes are green and which are red; every node is currently green.
