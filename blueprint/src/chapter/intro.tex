...
The Lean code is organized into nine phases, tracked in
\href{https://github.com/bryangingechen/CombinatorialRigidity/blob/master/ROADMAP.md}{\texttt{ROADMAP.md}}.
All nine phases are complete: the first six phases formalize Laman's
...
on top of a verified-DFS warmup.
...
fit together; every node is now green, including the main Laman
line, the Phase~7 / Phase~8 matroid identifications, the verified-DFS
warmup (\cref{sec:dfs}), and the Phase~9 pebble-game chapter
