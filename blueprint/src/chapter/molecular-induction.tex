...
\begin{lemma}[Rigid-subgraph contraction preserves minimality; KT Lemma 3.5]
  ...
  \uses{def:rigid-subgraph, lem:subgraph-minimality, def:k-dof, lem:rigid-full-rank, lem:contract-rank-bridge, lem:contract-deficiency-conservation}
...
\end{lemma}
\begin{proof}
  \uses{lem:contract-deficiency-conservation, lem:subgraph-minimality}
