...
\begin{lemma}[Case II realization: the $1$-extension produces a full-rank realization; KT Lemma 6.8]
  ...
  ($k = 0$), now green-modulo-N3b in its $d = 3$ algebra, with the realization
  ...
  the Case~III redundant-edge row (KT Lemma~6.10/6.13), now constructed
  green-modulo-N3b: the candidate-completion
  ...
  (\cref{lem:case-III-claim612}, KT eqs.~(6.30)--(6.45)); the one surviving red
  dependency of that $d = 3$ algebra is the point-join$\leftrightarrow$panel-meet
  duality \cref{lem:case-III-claim612-line-in-panel-union} (N3b, Phase~22f).
  ...
  $\mathtt{hsplit}$ --- the deferred ``$d = 3$ assembly''. The reusable green row
