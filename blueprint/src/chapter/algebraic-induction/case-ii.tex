...
\begin{lemma}[Case II realization, all $k \ge 0$: the splitting-off producer; KT Lemma 6.8]
  ...
  at a general-position, algebraically-independent seed. One hypothesis
  rides explicitly: a fresh edge name for $G$ itself (an unused label
  outside $E(G)$, needed for the splitting-off's short-circuit edge $e_0$).
\end{lemma}
\begin{proof}
  \leanok
