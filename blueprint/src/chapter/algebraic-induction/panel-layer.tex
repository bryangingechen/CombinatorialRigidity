...
\begin{theorem}[Theorem 5.5 at $d = 3$: the formalized instance; KT Theorem 5.5, \S6.4.1]
  ...
  and the three genuine-hinge slots
  $\mathtt{hbase}$/$\mathtt{hsplit}$/$\mathtt{hcontract}$, now typed at the
  honest genuine-hinge motive (\cref{def:genuine-hinge-realization})
  but still carried as explicit hypotheses pending the all-$k$ discharge. The
