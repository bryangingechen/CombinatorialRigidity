...
\cref{thm:def-eq-corank}. The analytic half below wires the
...
\begin{theorem}[Theorem 5.6 at $d = 3$: the specialization; KT Theorem 5.6, \S5.2]
  ...
  arbitrary deficiency, routed through the $d = 3$ instance of Theorem~5.5
...
\begin{remark}[Non-vacuity witness]
  ...
  The fresh-edge-label hypothesis threaded through the Theorem~5.5 spine and
