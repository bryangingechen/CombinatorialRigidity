...
\begin{theorem}[Theorem 5.5 at $d = 3$: the formalized instance; KT Theorem 5.5, \S6.4.1]
  ...
  \emph{The carried family.} The instance holds modulo three named
  hypotheses: $\mathtt{h65}$, the Lemma-6.5 vertex-removal arm of the
  Case-I dispatch (\cref{lem:case-I-dispatch}); and the two genuine-hinge
  slots $\mathtt{hsplit}$/$\mathtt{hcontract}$ (the no-rigid-subgraph and
  ...
  $\mathtt{h622}$ is discharged internally to \cref{lem:case-III} (Phase~22k~L7b).
...
\begin{proof}
  ...
  the $\Pi^\circ$-placement producer of \cref{lem:case-I-dispatch} (the
  $\mathtt{h65}$ carry is now discharged, Phase 22k L8c-2). For the
