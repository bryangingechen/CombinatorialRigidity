...
\begin{lemma}[Case III: $k = 0$, no proper rigid subgraph; KT Lemma 6.10/6.13]
  ...
  Claim~6.11, whose leaf-most prerequisite ---
  \cref{lem:case-III-claim-6-11-base}, the matroid-base 4.3(ii) form --- is
  green. KT then build $D$ candidate realizations and show one is rigid; the
