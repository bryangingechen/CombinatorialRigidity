...
(e.g.\ a non-collinear triple) by perturbation, used in the Phase 5
typeII rigidity-preservation argument
...
\begin{proof}
  ...
  $1$. Rank--nullity (\cref{lem:framework-finrank}) then gives
  $\dim\,(\ker) \le 2d - 1$, and the elementary inequality
