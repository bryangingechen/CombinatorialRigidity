...
\begin{lemma}[Cycle realizations; KT Lemma 5.4]
  ...
  \uses{def:rigidity-matrix, lem:cycle-realization-base}
  ...
  \cref{lem:cycle-realization-base}; the general cycle ($|V| \ge 3$)
  and the generic-panel independence argument supplying the
  independent supporting extensors (bottoming on the
