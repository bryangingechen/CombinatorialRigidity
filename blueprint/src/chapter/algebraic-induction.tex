...
(Claim~6.4/6.9) --- takes it as an explicit hypothesis, so it is green
\emph{modulo} that device, which is scoped out into the sub-phase
Phase~21b. The cycle-realization Lemma~5.4
(\cref{lem:cycle-realization}; Crapo--Whiteley~\cite{crapoWhiteley1982},
Whiteley~\cite{whiteley1999}) enters here as an input. The only remaining
red node is the crux Case~III (\cref{lem:case-III}), deferred to
Phases~22--23.
