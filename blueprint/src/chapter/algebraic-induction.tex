...
\begin{lemma}[Genericity device; KT Claim 6.4, Claim 6.9]
...
\end{lemma}
\begin{proof}
  Deferred to Phase~21b. A non-vanishing maximal minor of $R(G,p_0)$ is a
  polynomial in the panel coordinates that is nonzero at $p_0$, hence
  nonzero on a Zariski-open set; on that set the rank is at least the
  size of that minor. See \cite[\S6.1, \S6.3]{katohTanigawa2011}
  (Claim~6.4 and its Case-II twin Claim~6.9).
\end{proof}
