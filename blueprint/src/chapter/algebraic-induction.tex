...
\begin{proof}
  ...
  parameter; presenting each consumer's panel rows as an affine family
  along a chosen path (or generalizing the engine to the multivariate
  Zariski-open form) is the residual per-consumer wiring. See
