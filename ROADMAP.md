...
| 23. Case III general `d` (Lemma 6.13) → Thm 5.5/5.6 → Conjecture 1.2 | `Molecular/` (sub-lettered; codes-until-open) | ◐ In progress — 23a/CARRIER closed; 23b/CHAIN open (CHAIN-1/3/4 + OD-7 closed, CHAIN-2a closed; CHAIN-2b/2c + CHAIN-5 remain); ENTRY/ASSEMBLY remain (see `notes/Phase23b.md`) |
