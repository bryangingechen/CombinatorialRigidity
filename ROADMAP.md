...
| ⋮ Cleanup round (post-Phase-23) | blueprint molecular chapters — readability rewrite for the rigidity-theorist audience + Lean statement-surface audit | ◷ In progress (R0 + R1 through R1f landed; parked at owner checkpoint #4; see `notes/Phase23-cleanup.md`; round manual: `CLEANUP.md`) |
