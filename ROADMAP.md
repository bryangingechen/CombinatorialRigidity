...
| ⋮ Cleanup round (post-Phase-23) | blueprint molecular chapters — readability rewrite for the rigidity-theorist audience + Lean statement-surface audit | ◷ In progress (R1 complete, checkpoint #5 passed 2026-07-04; R2 next; see `notes/Phase23-cleanup.md`; round manual: `CLEANUP.md`) |
