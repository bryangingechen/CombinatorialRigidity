...
| ⋮ Perf pass (post-Phase-22l) | molecular file splits — `RigidityMatrix` bricks + core sectioning, `CaseIII/` (4 files) + `ForestSurgery/` (2 files) subdirectories | ◷ In progress (slices 1–6 landed; `RigidityMatrix` core split pending; see `notes/Phase22l-perf.md`; protocol: `notes/PERFORMANCE.md`) |
