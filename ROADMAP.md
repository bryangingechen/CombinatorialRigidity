...
| 22d. Claim 6.11's green-machinery prerequisites (matroid-base 4.3(ii) + nested-IH shell + seed-rank bridge) | `Molecular/Induction/ForestSurgery.lean` + `AlgebraicInduction/CaseI.lean` (extends `algebraic-induction.tex`) | ◷ In progress — Gap-2 leaf, Gap-3 shell, and the analytic seed-rank bridge green; next is the Gap-1 row bridge (see `notes/Phase22d.md`) |
