...
| ⋮ Perf pass (post-Phase-22l) | molecular file splits — `RigidityMatrix/Bricks.lean` carve (+ `ForestSurgery`/`CaseIII` candidates) | ◷ In progress (slice 1 landed; see `notes/Phase22l-perf.md`; protocol: `notes/PERFORMANCE.md`) |
