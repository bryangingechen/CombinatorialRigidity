...
| ⋮ Cleanup round (post-Phase-23) | blueprint molecular chapters — readability rewrite for the rigidity-theorist audience + Lean statement-surface audit | ◷ In progress (R0+R1 landed, stopped for owner review; see `notes/Phase23-cleanup.md`; round manual: `CLEANUP.md`) |
