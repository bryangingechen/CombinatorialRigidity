...
wired; its five other callbacks ride as hypotheses) → **Leaf 5** (a feed-audit pass, then the
remaining callback wiring + the banner flips + the Thm 5.5→5.6 push, unblocking Cor 5.7 at
`d=3`; see `notes/Phase22h.md` *Hand-off*). One genuinely open input rides as an explicitly carried
