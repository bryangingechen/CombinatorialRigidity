...
| ⋮ Perf pass (post-Phase-22l) | molecular file splits — `RigidityMatrix/Bricks.lean` carve + `CaseIII` sectioning (+ `CaseIII` cut / `ForestSurgery` candidates) | ◷ In progress (slices 1–2 landed; see `notes/Phase22l-perf.md`; protocol: `notes/PERFORMANCE.md`) |
