...
| ⋮ Perf pass (post-Phase-22l) | molecular file splits — `RigidityMatrix/Bricks.lean` carve + `CaseIII/` (4 files) + `ForestSurgery/` (2 files) subdirectories | ✓ Complete (see `notes/Phase22l-perf.md`; protocol: `notes/PERFORMANCE.md`) |
