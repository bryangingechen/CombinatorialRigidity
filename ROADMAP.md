...
| ⋮ Cleanup round (post-Phase-23) | blueprint molecular chapters — readability rewrite for the rigidity-theorist audience + Lean statement-surface audit | ◷ In progress (R0 + R1 through R1f landed; checkpoint #4 adjudicated, revision arc executing; see `notes/Phase23-cleanup.md`; round manual: `CLEANUP.md`) |
