...
| 23. Case III general `d` (Lemma 6.13) → Thm 5.5/5.6 → Conjecture 1.2 | `Molecular/` (sub-lettered; codes-until-open) | ◐ In progress — 23a–23f closed; **23g** open (ENTRY): CHAIN-5 + E1–E4 + E2 (KT Lemma 4.6) + E3 landed — `hextract` discharged at general `n`; remaining = E5 (the Lemma 5.4 cycle brick `hcycle`; recon settled, 3 sub-commits — **E5a+E5b landed** (cyclic normals + α-level cycle rigidity), E5c remains). `d=3` fully green. (see `notes/Phase23g.md` + `notes/MolecularConjecture.md`) |
