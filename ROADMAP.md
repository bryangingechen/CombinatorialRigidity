...
| 23. Case III general `d` (Lemma 6.13) → Thm 5.5/5.6 → Conjecture 1.2 | `Molecular/` (sub-lettered; codes-until-open) | ◐ In progress — 23a/CARRIER closed; 23b/CHAIN open on a detailed recon (no build); ENTRY/ASSEMBLY remain (see `notes/Phase23b.md`) |
