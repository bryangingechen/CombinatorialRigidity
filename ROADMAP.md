...
| 12. Matroid foundations (submodular + union) | `CombinatorialRigidity/Matroid/` | in progress (Layer 2a done, Layer 2b underway — union construction landed, partition rank theorem remaining; see `notes/Phase12.md`) |
