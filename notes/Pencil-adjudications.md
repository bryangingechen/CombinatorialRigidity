# PENCIL phase-note adjudications — archived selection history (ordinals 1–44)

**What this is.** The dated, verbatim-quoted user adjudication and delegation
...
touching (K), (K-bare) or W4 — 2026-07-24 (the phase stays open), 2026-07-30 ×2
(the (K) and (K-bare) routes), 2026-08-02 (W4 route 3, packaging (b)),
2026-08-05 (the reproducibility requirement) — plus a **compressed statement of
the standing research-pick delegation and its two selection criteria** and of
the **direction-A pivot rule's pre-adjudicated stop clause**. Those are live
constraints, not archival selection history, so a summary of each stays in the
phase note; the **verbatim** user quotes behind all of them are here.

**Reading this file.** A citation naming one of these dated bullets by date now
resolves here — including the 2026-08-19 eighth-fan-out bullet's SIGZ
authorization terms, the 2026-08-26 seventh check-in's second and third calls
(the widened delegation; the pre-adjudicated stop clause), the eighth
check-in's target-distance criterion, the tenth's max-impact criterion and
standing Zheng lane, and the eleventh's measured headroom re-calibration.
Per-direction mathematical verdicts are **not** here — they live in
`notes/Pencil-fanout{,-archive}.md` and the (K) workbook, as before; this file
is dispatch-*selection* provenance only, never mathematics.
