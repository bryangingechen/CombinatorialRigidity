...
live in `notes/Phase22a.md`. **Phase 22b is in progress, terminal green-modulo-`htransport`**
(KT Claim 6.4 — the discharge of 22a's green-modulo obligation; all three planned nodes
N-22b-1/2/3 landed 2026-06-05, so `lem:claim-6-4` is formalized down to its single
irreducible analytic core, but it stays red green-modulo the explicit hypothesis
`htransport` = KT eq. (6.9)'s algebraic-independence rank-attainment across the collapse
relabel, whose discharge is a deferred future sub-phase; see `notes/Phase22b.md`);
...
#### Phase 22 — Realization layer (sub-lettered: 22a + 22b + 22c+) (§6.2, §6.3, §6.4.1)
...
obligation, `notes/Phase22b.md`, ◷ in progress, opened 2026-06-05, opening recon
landed); **22c+** = the parked Case III at `d=3` + the `d=3` assembly (◷ planning,
