...
| `deltas_at`, `delta_all_pairs`, `extended_construction`, `g_exact`, `split_battery`, `two_cut_census` | **`w4/btwocut`** | **`w4/bimage`**, **`w4/bearcase`**, **`w4/bearfull`**, **`w4/bsharp`**, **`w4/brule`** (5 — the **FIRST external consumer of any `btwocut` device**, recorded 2026-08-27 at the BIMAGE landing; a second arrived the same day at the BEARCASE landing, which **trips the §2 rule-2 threshold** — recorded, no move made) |
...
| `dist_in_graph`, `far_piece_battery` | **`w4/bearfull`** | **`w4/bsharp`**, **`w4/brule`** (2 — the **FIRST external consumer of any `bearfull` device**, recorded 2026-08-28 at the BSHARP landing; BRULE the second the same day, which **trips the §2 rule-2 threshold** — recorded, no move made) |
