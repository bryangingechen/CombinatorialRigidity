...
| `a_battery`, the flag-regime builders, `loss_of`, `reach_pred`, **`bad_predicate` / `reach_measured` / `pencil_vertex` / `sample_flags` (BRULE)** | **`w4/bimage`** | **`w4/bearcase`**, **`w4/bearfull`**, **`w4/bsharp`**, **`w4/brule`**, **`w4/bwin`**, **`w4/brnode`**, **`w4/bdecor`** (7 — the **FIRST external consumer of any `bimage` device**, recorded 2026-08-27 at the BEARCASE landing. Recorded so the next consumer trips the §2 rule-2 threshold rather than rediscovering it) |
...
| `build_piece`, `K4_named`, `PRISM_named` | **`w4/brnode`** | **`w4/bdecor`** (1 — the **FIRST external consumer of any `brnode` device**, recorded 2026-09-01 at the BDECOR landing. Recorded so the next consumer trips the §2 rule-2 threshold rather than rediscovering it) |
