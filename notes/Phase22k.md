...
- [ ] **L8** (in progress) — the Lemma-6.5 arm: KT Claim 6.6 graph side + the Π°-placement producer;
  `h65` carry discharged **at L8c** (still open). **Signature-pinned in §1.70.** **L8a ✓** — all Claim 6.6 graph-side pieces
