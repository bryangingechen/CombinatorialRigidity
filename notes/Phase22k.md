...
`lem:case-I-dispatch` red→green (reword the "22i" stale prose to "22k"). Statement-grep gate on `theorem_55_d3`
before the L8c-2 commit (the `h65` carry-drop is a statement change).
