...
**Direction O has LANDED** (2026-08-06): its row is released into the registry —
(OC-10)–(OC-16), Steps O9–O12, `outerwide.py`'s four modes and `outerwide.m2`
now live in §(K-out)'s row below. Q and G remain reserved until each lands.
