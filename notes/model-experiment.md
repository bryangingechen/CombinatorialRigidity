...
### Session #29 (rows 429–431) — the coordinator's shape check + two read-only spikes caught a `W`-shape satisfiability mis-target AND proved the relocated-`hρGv`-wall: option (A) is INFEASIBLE
