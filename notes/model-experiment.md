...
**active sub-phase's** rows (23g closed 2026-07-02; **23h not yet opened**, no
rows yet), and active-phase *Findings*, so the coordinator's every-dispatch read stays small. **When a
...
- **Testbed:** the molecular program — **Phase 23** (Case III general `d`:
  ...
  codes-until-open). **23g closed 2026-07-02** (ENTRY complete);
  **23h (ASSEMBLY) next, not yet opened**. Closed
