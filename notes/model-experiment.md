...
### Session #29 (rows 429–432) — the coordinator's shape check + three read-only spikes proved the relocated-`hρGv`-wall: BOTH `±r`-corner wall-escape routes (A AND B′) are INFEASIBLE
